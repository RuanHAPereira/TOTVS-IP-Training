...
/*/{Protheus.doc} User Function MsPedCom
    ...
    @since 13/04/2023
    /*/
User Function MsPedCom() //? função de usuario para montar a regua de processamento
...
Static Function MontaRel(cAlias) //? Função para montar o relatorio
...
Static Function Cabecalho(cAlias) //? Função que cria cabeçalho
...
Static Function Print(cAlias) //? Função para imprimir relatorio
...
Static Function BreakLine(cString, nQtdCar, nCol) //? Funçao que verifica se necessita de quebra de linha
...
Static Function BreakPage() //? Função qeu verifica se necessita quebra de pagina
