...
/*/{Protheus.doc} User Function DelPasta
  Função para a exclusão de pastas através do ADVPL.
  @type  Function
  @author Ruan Pereira
  @since 24/04/2023
  /*/
User Function DelPasta()
  ...
  Local cPasta    := 'C:\Exercicios_TOTVS\lista 13 - ex1' //? Caminho da pasta que será excluída
  //? Pegando os dados de todos os arquivos exeistentes dentro da pasta
  Local aArquivos := Directory(cPasta + 'arquivolista13.txt' /*Caminho + Tipos de Arquivos*/, 'D' /*Atribuos*/,/*Comp*/,/*Case Sensitive*/, 1 /*Ordenação dos arquivos*/)
  Local nI        := 0
