...
/*/{Protheus.doc} User Function RpPedido
    Função de gerar relatório pedido de compra selecionado
    @type  Function
    @author Ruan Pereira
    @since 08/04/2023
/*/
User Function RpPedido()
...
Static Function GeraReport()
	...
	Local oRel      := TReport():New('RpPedido', 'Relatório de Pedidos de Compra',, { |oRel| Print(oRel, cAlias) }, 'Esse Relatório Imprimirá o Pedido de Compra Selecionado', .F.)
